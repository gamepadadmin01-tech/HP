...
description: How to read and regenerate the GamepadOS notes PDFs in F:\hlooo\docs\notes
metadata: 
  node_type: memory
  type: reference
...
**Writing new Parts:** `F:\hlooo\apps\docs\make_guide_part.py` (written 2026-07-26)
