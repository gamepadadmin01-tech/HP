...
description: "iOS/Mac expansion: iPhone controller app authored at D:\AKHIL\HP\hlooo\apps\ios-client (needs Mac to build), Mac server unresearched"
metadata: 
  node_type: memory
  type: project
